CREATE OR REPLACE PACKAGE  stpks_stdklei4_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdklei4_custom.spc
  **
...
/
CREATE OR REPLACE SYNONYM stpkss_stdklei4_custom FOR stpks_stdklei4_custom
/