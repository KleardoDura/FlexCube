CREATE OR REPLACE PACKAGE  stpks_stdklei3_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdklei3_main.spc
  **
...
TYPE ty_tb_v_sttm_klei3_details IS TABLE OF sttm_klei3_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdklei3 IS RECORD (
     v_sttm_klei3     sttm_klei3%ROWTYPE,
     v_sttm_klei3_details    ty_tb_v_sttm_klei3_details,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdklei3_main FOR stpks_stdklei3_main
/