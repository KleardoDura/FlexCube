CREATE OR REPLACE PACKAGE  stpks_stdklei2_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdklei2_main.spc
  **
...
TYPE ty_tb_v_sttm_klei2_details IS TABLE OF sttm_klei2_details%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdklei2 IS RECORD (
     v_sttm_klei2     sttm_klei2%ROWTYPE,
     v_sttm_klei2_details    ty_tb_v_sttm_klei2_details,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdklei2_main FOR stpks_stdklei2_main
/