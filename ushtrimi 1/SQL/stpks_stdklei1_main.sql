CREATE OR REPLACE PACKAGE BODY stpks_stdklei1_main AS
     /*-----------------------------------------------------------------------------------------------------
     **
     ** File Name  : stpks_stdklei1_main.sql
     **
   ...
   g_Ui_Name            VARCHAR2(50) := 'STDKLEI1';
   g_stdklei1         stpks_stdklei1_Main.ty_stdklei1;
   ...
   BEGIN
      stpks_stdklei1_Custom.Pr_Skip_Handler (P_Stage);
   END Pr_Skip_Handler;
   ...
   FUNCTION Fn_Sys_Build_Fc_Type (p_Source    IN     VARCHAR2,
      ...
      p_stdklei1       IN   OUT stpks_stdklei1_Main.ty_stdklei1,
   ...
   BEGIN
      ...
      LOOP
         ...
         IF  l_Node = 'BLK_KLEI' THEN
            p_stdklei1.v_sttm_klei.DESCRIPTION1 := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.GROUP_CODE := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.GROUP_STATUS := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.GROUP_TYPE := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdklei1.v_sttm_klei.SINCE := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdklei1.v_sttm_klei.SINCE := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdklei1.v_sttm_klei.MAKER_ID := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdklei1.v_sttm_klei.MAKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdklei1.v_sttm_klei.MAKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdklei1.v_sttm_klei.CHECKER_ID := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdklei1.v_sttm_klei.CHECKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdklei1.v_sttm_klei.CHECKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdklei1.v_sttm_klei.MOD_NO := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.RECORD_STAT := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.AUTH_STAT := Cspks_Req_Global.Fn_GetVal;
            p_stdklei1.v_sttm_klei.ONCE_AUTH := Cspks_Req_Global.Fn_GetVal;
         END IF;
         l_Node := Cspks_Req_Global.Fn_GetNode;
      END LOOP;

      p_stdklei1.Addl_Info := p_Addl_Info;
      Dbg('Returning Success From Fn_Sys_Build_Fc_Type.. ');
      RETURN TRUE;

   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Sys_Build_Fc_Type ');
   ...
   BEGIN
      ...
      LOOP
         --Dbg('Node Name  :'||l_Node);
         IF  l_Node IN ( 'BLK_KLEI','Klei-Full','Klei-IO') THEN
            l_Key       := Cspks_Req_Global.Fn_GetTag;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            WHILE (l_Key <> 'EOPL')
            LOOP
               --dbg('Key/Value   :'||l_Key ||':'||l_Val);
               IF l_Key = 'DESCRIPTION1' THEN
                  p_stdklei1.v_sttm_klei.DESCRIPTION1 := l_Val;
               ELSIF l_Key = 'EXPOSURE_CATEGORY' THEN
                  p_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY := l_Val;
               ELSIF l_Key = 'GROUP_CODE' THEN
                  p_stdklei1.v_sttm_klei.GROUP_CODE := l_Val;
               ELSIF l_Key = 'GROUP_STATUS' THEN
                  p_stdklei1.v_sttm_klei.GROUP_STATUS := l_Val;
               ELSIF l_Key = 'GROUP_TYPE' THEN
                  p_stdklei1.v_sttm_klei.GROUP_TYPE := l_Val;
               ...
               ELSIF l_Key = 'MAKER' THEN
                  p_stdklei1.v_sttm_klei.MAKER_ID := l_Val;
               ...
               ELSIF l_Key = 'CHECKER' THEN
                  p_stdklei1.v_sttm_klei.CHECKER_ID := l_Val;
               ...
               ELSIF l_Key = 'MODNO' THEN
                  p_stdklei1.v_sttm_klei.MOD_NO := l_Val;
               ELSIF l_Key = 'TXNSTAT' THEN
                  p_stdklei1.v_sttm_klei.RECORD_STAT := l_Val;
               ELSIF l_Key = 'AUTHSTAT' THEN
                  p_stdklei1.v_sttm_klei.AUTH_STAT := l_Val;
               ELSIF l_Key = 'ONCEAUTH' THEN
                  p_stdklei1.v_sttm_klei.ONCE_AUTH := l_Val;
               END IF;
               l_Key       := Cspks_Req_Global.Fn_GetTag;
               l_Val       := Cspks_Req_Global.Fn_GetVal;
            END LOOP;
   ...
   FUNCTION Fn_Sys_Build_Fc_Ts (p_Source    IN     VARCHAR2,
                              ...
                              p_Function_Id       IN     VARCHAR2,
                              p_Action_Code       IN     VARCHAR2,
      p_stdklei1          IN stpks_stdklei1_Main.ty_stdklei1,
      p_Err_Code        IN OUT VARCHAR2,
      p_Err_Params      IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      Cspks_Req_Global.Pr_Write('P','BLK_KLEI',l_Level_Format);
      Cspks_Req_Global.Pr_Write('V','DESCRIPTION1',p_stdklei1.v_sttm_klei.description1);
      Cspks_Req_Global.Pr_Write('V','EXPOSURE_CATEGORY',p_stdklei1.v_sttm_klei.exposure_category);
      Cspks_Req_Global.Pr_Write('V','GROUP_CODE',p_stdklei1.v_sttm_klei.group_code);
      Cspks_Req_Global.Pr_Write('V','GROUP_STATUS',p_stdklei1.v_sttm_klei.group_status);
      Cspks_Req_Global.Pr_Write('V','GROUP_TYPE',p_stdklei1.v_sttm_klei.group_type);
      IF trunc(p_stdklei1.v_sttm_klei.since) <>
            p_stdklei1.v_sttm_klei.since THEN
         l_Date_Val :=  TO_CHAR( p_stdklei1.v_sttm_klei.since,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdklei1.v_sttm_klei.since,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','SINCE',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','MAKER',p_stdklei1.v_sttm_klei.maker_id);
      IF trunc(p_stdklei1.v_sttm_klei.maker_dt_stamp) <>
            p_stdklei1.v_sttm_klei.maker_dt_stamp THEN
         l_Date_Val :=  TO_CHAR( p_stdklei1.v_sttm_klei.maker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdklei1.v_sttm_klei.maker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','MAKERSTAMP',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','CHECKER',p_stdklei1.v_sttm_klei.checker_id);
      IF trunc(p_stdklei1.v_sttm_klei.checker_dt_stamp) <>
            p_stdklei1.v_sttm_klei.checker_dt_stamp THEN
         l_Date_Val :=  TO_CHAR( p_stdklei1.v_sttm_klei.checker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdklei1.v_sttm_klei.checker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','CHECKERSTAMP',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','MODNO',p_stdklei1.v_sttm_klei.mod_no);
      Cspks_Req_Global.Pr_Write('V','TXNSTAT',p_stdklei1.v_sttm_klei.record_stat);
      Cspks_Req_Global.Pr_Write('V','AUTHSTAT',p_stdklei1.v_sttm_klei.auth_stat);
      Cspks_Req_Global.Pr_Write('V','ONCEAUTH',p_stdklei1.v_sttm_klei.once_auth);
   ...
   BEGIN
      ...
      IF SUBSTR(p_Exchange_Pattern,3,4) = 'FS' THEN
         ...
         --Dbg('Building Childs Of :..');
         IF (  p_stdklei1.v_sttm_klei.group_code IS NOT NULL 
          )
          THEN
            l_0_Lvl_Counter   := l_0_Lvl_Counter +1;
            l_Level_Format      := l_0_Lvl_Counter;
            Cspks_Req_Global.Pr_Write('P','Klei-Full',l_Level_Format);
            Cspks_Req_Global.Pr_Write('V','DESCRIPTION1',p_stdklei1.v_sttm_klei.description1);
            Cspks_Req_Global.Pr_Write('V','EXPOSURE_CATEGORY',p_stdklei1.v_sttm_klei.exposure_category);
            Cspks_Req_Global.Pr_Write('V','GROUP_CODE',p_stdklei1.v_sttm_klei.group_code);
            Cspks_Req_Global.Pr_Write('V','GROUP_STATUS',p_stdklei1.v_sttm_klei.group_status);
      ...
      ELSE
         ...
         Cspks_Req_Global.pr_Write('P','Klei-PK','1');
         l_Key_Cols := 'GROUP_CODE~';
         l_Key_Vals := p_stdklei1.v_sttm_klei.group_code||'~';
   ...
   BEGIN
      ...
      l_Fld := 'STTM_KLEI.GROUP_CODE';
      IF p_stdklei1.v_sttm_klei.group_code IS Null THEN
   ...
   BEGIN
      ...
      IF p_stdklei1.v_sttm_klei.GROUP_TYPE IS NOT NULL THEN
         IF p_stdklei1.v_sttm_klei.GROUP_TYPE NOT IN ('corporate','retail','charge','clearing','tax') THEN
            dbg('Invalid Value For The Field  :GROUP_TYPE:'||p_stdklei1.v_sttm_klei.GROUP_TYPE);
            Pr_Log_Error(p_Source,'ST-VALS-011',p_stdklei1.v_sttm_klei.GROUP_TYPE||'~@STTM_KLEI.GROUP_TYPE~@STTM_KLEI') ;
         END IF;
      END IF;
   ...
   FUNCTION Fn_Sys_Default_Vals        (p_Source            IN VARCHAR2,
      p_Wrk_stdklei1     IN  OUT stpks_stdklei1_Main.ty_stdklei1,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   FUNCTION Fn_Sys_Merge_Amendables        (p_Source            IN VARCHAR2,
      p_Source_Operation  IN     VARCHAR2,
      p_stdklei1     IN  stpks_stdklei1_Main.Ty_stdklei1,
      p_Prev_stdklei1 IN stpks_stdklei1_Main.Ty_stdklei1,
      p_Wrk_stdklei1 IN OUT stpks_stdklei1_Main.Ty_stdklei1,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      l_fld := 'STTM_KLEI.DESCRIPTION1';
      IF Fn_Amendable('STTM_KLEI.DESCRIPTION1') THEN
         p_Wrk_stdklei1.v_sttm_klei.description1 := p_stdklei1.v_sttm_klei.description1;
      ELSE
         IF p_stdklei1.v_sttm_klei.description1 IS NOT NULL THEN
            IF NVL(p_Wrk_stdklei1.v_sttm_klei.description1,'@') <>
               NVL(p_stdklei1.v_sttm_klei.description1,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTM_KLEI.EXPOSURE_CATEGORY';
      IF Fn_Amendable('STTM_KLEI.EXPOSURE_CATEGORY') THEN
         p_Wrk_stdklei1.v_sttm_klei.exposure_category := p_stdklei1.v_sttm_klei.exposure_category;
      ELSE
         IF p_stdklei1.v_sttm_klei.exposure_category IS NOT NULL THEN
            IF NVL(p_Wrk_stdklei1.v_sttm_klei.exposure_category,'@') <>
               NVL(p_stdklei1.v_sttm_klei.exposure_category,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTM_KLEI.GROUP_STATUS';
      IF Fn_Amendable('STTM_KLEI.GROUP_STATUS') THEN
         p_Wrk_stdklei1.v_sttm_klei.group_status := p_stdklei1.v_sttm_klei.group_status;
      ELSE
         IF p_stdklei1.v_sttm_klei.group_status IS NOT NULL THEN
            IF NVL(p_Wrk_stdklei1.v_sttm_klei.group_status,'@') <>
               NVL(p_stdklei1.v_sttm_klei.group_status,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTM_KLEI.GROUP_TYPE';
      IF Fn_Amendable('STTM_KLEI.GROUP_TYPE') THEN
         p_Wrk_stdklei1.v_sttm_klei.group_type := p_stdklei1.v_sttm_klei.group_type;
      ELSE
         IF p_stdklei1.v_sttm_klei.group_type IS NOT NULL THEN
            IF NVL(p_Wrk_stdklei1.v_sttm_klei.group_type,'@') <>
               NVL(p_stdklei1.v_sttm_klei.group_type,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      END IF;
      l_fld := 'STTM_KLEI.SINCE';
      IF Fn_Amendable('STTM_KLEI.SINCE') THEN
         p_Wrk_stdklei1.v_sttm_klei.since := p_stdklei1.v_sttm_klei.since;
      ELSE
         IF p_stdklei1.v_sttm_klei.since IS NOT NULL THEN
            IF NVL(p_Wrk_stdklei1.v_sttm_klei.since,global.min_date) <>
               NVL(p_stdklei1.v_sttm_klei.since,global.min_date)  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
   ...
   FUNCTION Fn_Sys_Check_Mandatory_Nodes  (p_Source            IN VARCHAR2,
      p_Wrk_stdklei1 IN  stpks_stdklei1_Main.Ty_stdklei1,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      l_Blk := 'STTM_KLEI';
      l_Fld := 'STTM_KLEI.EXPOSURE_CATEGORY';
      IF p_wrk_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY IS NOT NULL THEN
         SELECT COUNT(*) INTO l_LOV_COUNT  FROM  (select EXPOSURE_CATEGORY from LOV_EXPOSURE_CATEGORY_KLEI) WHERE EXPOSURE_CATEGORY = P_wrk_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY;
         IF l_lov_count = 0  THEN
            Dbg('Invalid Value For The Field  :EXPOSURE_CATEGORY:'||p_Wrk_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY);
            Pr_Log_Error(p_Source,'ST-VALS-011',p_Wrk_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY||'~@STTM_KLEI.EXPOSURE_CATEGORY~@STTM_KLEI') ;
         END IF;
      END IF;
   ...
   FUNCTION Fn_Sys_Default_And_Validate        (p_Source            IN VARCHAR2,
      ...
      p_Action_Code       IN     VARCHAR2,
      p_stdklei1     IN  stpks_stdklei1_Main.Ty_stdklei1,
      p_Prev_stdklei1 IN OUT  stpks_stdklei1_Main.Ty_stdklei1,
      p_Wrk_stdklei1 IN OUT  stpks_stdklei1_Main.Ty_stdklei1,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      IF p_Source <> 'FLEXCUBE'  THEN
         ...
         END;
      END IF;
      l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_KLEI.GROUP_CODE')||'-'||
      p_stdklei1.v_sttm_klei.group_code;
      l_Prev_Key_Tags := 'GROUP_CODE~';
      l_Prev_Key_Vals := p_prev_stdklei1.v_sttm_klei.group_code||'~';
      Dbg('Calling Cspks_Req_Utils.Fn_Maint_Basic_Validations..');
      IF NOT Cspks_Req_Utils.Fn_Maint_Basic_Validations (p_source,
         p_Source_Operation,
         p_Function_Id,
         p_Action_Code,
         p_Prev_stdklei1.v_sttm_klei.Mod_No,
         p_stdklei1.v_sttm_klei.Mod_No,
         p_Prev_stdklei1.v_sttm_klei.Auth_Stat,
         p_Prev_stdklei1.v_sttm_klei.Record_Stat,
         p_Prev_stdklei1.v_sttm_klei.Once_Auth,
         l_Prev_Key_Tags,
         l_Prev_Key_Vals,
         g_Key_Id,
         l_Key,
      ...
      IF ( p_Action_Code IN (Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete,Cspks_Req_Global.p_Query) OR
            ( p_Action_Code = Cspks_Req_Global.p_Modify AND NVL(p_Prev_stdklei1.v_sttm_klei.Once_Auth,'N') = 'Y')) THEN
         p_Wrk_stdklei1 := p_Prev_stdklei1;
         p_wrk_stdklei1.v_sttm_klei.Mod_No := p_stdklei1.v_sttm_klei.Mod_No;
         p_Wrk_stdklei1.Addl_Info := p_stdklei1.Addl_Info ;
      ELSE
         p_Wrk_stdklei1 := p_stdklei1;
      END IF;
      IF p_Action_Code = Cspks_Req_Global.p_Auth THEN
         IF p_Wrk_stdklei1.v_sttm_klei.Mod_No IS NULL THEN
            p_Wrk_stdklei1.v_sttm_klei.Mod_No           := p_prev_stdklei1.v_sttm_klei.Mod_No;
         END IF;
         p_Wrk_stdklei1.v_sttm_klei.Checker_dt_stamp   := fn_mntstamp;
         p_Wrk_stdklei1.v_sttm_klei.Checker_id         := Global.user_id;
      ELSIF p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
         p_Wrk_stdklei1.v_sttm_klei.Auth_Stat        := 'U';
         IF NOT Cspks_Req_Global.Fn_UnTanking THEN
            p_Wrk_stdklei1.v_sttm_klei.Maker_Id         := Global.User_Id;
            p_Wrk_stdklei1.v_sttm_klei.Maker_Dt_Stamp   := Fn_Mntstamp;
         ELSE
            p_Wrk_stdklei1.v_sttm_klei.Maker_Id         := NVL(p_stdklei1.v_sttm_klei.Maker_Id,Global.User_Id);
            p_Wrk_stdklei1.v_sttm_klei.Maker_Dt_Stamp   := NVL(p_stdklei1.v_sttm_klei.Maker_Dt_Stamp,Fn_Mntstamp);
         END IF;

         IF p_Action_Code = Cspks_Req_Global.p_New THEN
            IF NOT Cspks_Req_Global.Fn_UnTanking THEN
               p_Wrk_stdklei1.v_sttm_klei.Mod_No           := 1;
            ELSE
               p_Wrk_stdklei1.v_sttm_klei.Mod_No := NVL(p_Wrk_stdklei1.v_sttm_klei.Mod_No,1);
            END IF;
            p_Wrk_stdklei1.v_sttm_klei.Record_Stat      := 'O';
            p_Wrk_stdklei1.v_sttm_klei.Once_Auth        := 'N';
         ELSE
            IF NOT Cspks_Req_Global.Fn_UnTanking THEN
               p_wrk_stdklei1.v_sttm_klei.Mod_No           := NVL(p_prev_stdklei1.v_sttm_klei.Mod_No,0)+1;
            ELSE
               p_Wrk_stdklei1.v_sttm_klei.Mod_No           := NVL(p_stdklei1.v_sttm_klei.Mod_No,1);
            END IF;
            p_Wrk_stdklei1.v_sttm_klei.Once_Auth           := NVL(p_Prev_stdklei1.v_sttm_klei.Once_Auth,'N');
            p_wrk_stdklei1.v_sttm_klei.Record_Stat           := NVL(p_prev_stdklei1.v_sttm_klei.Record_Stat,'O');
         END IF;
         IF p_Action_Code = Cspks_Req_Global.p_Close THEN
            p_Wrk_stdklei1.v_sttm_klei.Record_Stat      := 'C';
         ELSIF p_Action_Code = Cspks_Req_Global.p_Reopen THEN
            p_Wrk_stdklei1.v_sttm_klei.Record_Stat      := 'O';
         END IF;
         p_Wrk_stdklei1.v_sttm_klei.Checker_id         := Null;
         p_Wrk_stdklei1.v_sttm_klei.Checker_Dt_Stamp         := Null;
      ...
      IF p_Action_Code in  (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify) THEN
         ...
         IF p_Action_Code = Cspks_Req_Global.p_New OR  ( p_Action_Code = Cspks_Req_Global.p_Modify AND p_Prev_stdklei1.v_sttm_klei.Once_Auth = 'N') THEN
         ...
         END IF;
         IF p_Action_Code = Cspks_Req_Global.p_Modify AND p_Prev_stdklei1.v_sttm_klei.Once_Auth = 'Y'THEN
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Sys_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      ELSE
         ...
         IF NVL(p_With_Lock,'N') = 'Y' THEN
            BEGIN
               SELECT *
               INTO   p_wrk_stdklei1.v_sttm_klei
               FROM  STTM_KLEI
               WHERE group_code = p_stdklei1.v_sttm_klei.group_code
                FOR UPDATE NOWAIT;
            EXCEPTION
   ...
   BEGIN
      ...
      IF p_Action_Code = Cspks_Req_Global.p_new THEN
         ...
         Dbg('Inserting Into STTM_KLEI..');
         BEGIN
            IF  p_wrk_stdklei1.v_sttm_klei.group_code IS NOT NULL THEN
               Dbg('Record Sent..');
               INSERT INTO  STTM_KLEI
               VALUES p_wrk_stdklei1.v_sttm_klei;
            END IF;
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed In Insert intoSTTM_KLEI..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTM_KLEI';
               RETURN FALSE;
         END;
      ELSIF p_Action_Code = Cspks_Req_Global.p_modify THEN

         Dbg('Updating Single Record Node :  STTM_KLEI..');
         BEGIN
            UPDATE STTM_KLEI
            SET
            DESCRIPTION1 = p_Wrk_stdklei1.v_sttm_klei.DESCRIPTION1,
            EXPOSURE_CATEGORY = p_Wrk_stdklei1.v_sttm_klei.EXPOSURE_CATEGORY,
            GROUP_STATUS = p_Wrk_stdklei1.v_sttm_klei.GROUP_STATUS,
            GROUP_TYPE = p_Wrk_stdklei1.v_sttm_klei.GROUP_TYPE,
            SINCE = p_Wrk_stdklei1.v_sttm_klei.SINCE,
            MAKER_ID = p_Wrk_stdklei1.v_sttm_klei.MAKER_ID,
            MAKER_DT_STAMP = p_Wrk_stdklei1.v_sttm_klei.MAKER_DT_STAMP,
            CHECKER_ID = p_Wrk_stdklei1.v_sttm_klei.CHECKER_ID,
            CHECKER_DT_STAMP = p_Wrk_stdklei1.v_sttm_klei.CHECKER_DT_STAMP,
            MOD_NO = p_Wrk_stdklei1.v_sttm_klei.MOD_NO,
            RECORD_STAT = p_Wrk_stdklei1.v_sttm_klei.RECORD_STAT,
            AUTH_STAT = p_Wrk_stdklei1.v_sttm_klei.AUTH_STAT,
            ONCE_AUTH = p_Wrk_stdklei1.v_sttm_klei.ONCE_AUTH
WHERE group_code = p_Wrk_stdklei1.v_sttm_klei.group_code
;
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed in Insert Into STTM_KLEI..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTM_KLEI';
               RETURN FALSE;
      ...
      ELSIF p_Action_Code = Cspks_Req_Global.p_delete THEN
         ...
         DELETE STTM_KLEI WHERE group_code = p_Wrk_stdklei1.v_sttm_klei.group_code
         ;


      ELSIF p_Action_Code IN (Cspks_Req_Global.p_Auth,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen ) THEN
         l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_KLEI.GROUP_CODE')||'-'||
         p_Wrk_stdklei1.v_sttm_klei.group_code;
         BEGIN
            SELECT ROWID
            INTO   l_row_id
            FROM  STTM_KLEI
         ...
         IF NOT Cspks_Req_Utils.Fn_Maint_Operations(p_Source,
            ...
            'STTM_KLEI',
            l_Row_Id,
            p_Wrk_stdklei1.v_sttm_klei.mod_no,
            p_Wrk_stdklei1.v_sttm_klei.Maker_dt_Stamp,
            p_Wrk_stdklei1.v_sttm_klei.Checker_dt_Stamp,
            g_Key_Id,
            l_Key,
            p_Err_Code,
            p_Err_params) THEN
   ...
   BEGIN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Post_Build_Type_Structure(p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            l_Child_Function,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in stpks_stdklei1_Custom.Fn_Post_Build_Type_Structure..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Build_Type ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         debug.pr_debug('**','In when others of stpks_stdklei1_Main.Fn_Build_Ts_List ..');
         debug.pr_debug('**',SQLERRM);
         p_err_code    := 'ST-OTHR-001';
         p_err_params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT Cspks_Req_Utils.Fn_Get_Key_Information(p_Source,
         ...
         l_Key_Cols,
         l_Key_Vals,
         p_stdklei1.Addl_Info,
         p_Err_Code,
         p_Err_Params) THEN
         Dbg('Failed in  Cspks_Req_Utils.Fn_Get_Key_Information..');
         RETURN FALSE;
      END IF;
      IF p_stdklei1.Addl_Info.EXISTS('RECORD_KEY') THEN
         G_Req_Key :=  p_stdklei1.Addl_Info('RECORD_KEY');
      END IF;
      IF p_stdklei1.Addl_Info.EXISTS('KEY_ID') THEN
         G_Key_Id :=  p_stdklei1.Addl_Info('KEY_ID');
      END IF;
      p_stdklei1.Addl_Info('SENT_MOD_NO') :=p_stdklei1.v_sttm_klei.Mod_No;
      Dbg('Returning Succsess From Fn_Get_Key_Information..');
      RETURN TRUE;

   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Get_Key_Information..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Pre_Check_Mandatory (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in  stpks_stdklei1_Custom.Fn_Pre_Check_Mandatory..');
            RETURN FALSE;
         END IF;
      END IF;

      IF NOT stpks_stdklei1_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Post_Check_Mandatory (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in  stpks_stdklei1_Custom.Fn_Post_Check_Mandatory..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Check_Mandatory ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      l_Mod_No := p_stdklei1.v_sttm_klei.Mod_No;
      ...
      IF l_Tanked_data_Found THEN
         IF l_Bld_Type_From_Tanked_Data THEN
            ...
            stpks_stdklei1_Main.Pr_Set_Skip_custom;
            Pr_Skip_Handler('POSTTANKQRY');
            Dbg('Calling Post Query Hooks After Query Of Tanked Data');
            IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
               IF NOT stpks_stdklei1_Custom.Fn_Post_Query (p_Source,
                  p_Source_operation,
                  p_Function_id,
                  p_Action_Code,
                  p_Function_Id  ,
                  ...
                  p_Err_Code,
                  p_Err_Params) THEN
                  Dbg('Failed in stpks_stdklei1_Custom.Fn_Post_Query of Tanked Data');
                  RETURN FALSE;
               END IF;
            END IF;
      ...
      ELSE
         ...
         IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
            IF NOT stpks_stdklei1_Custom.Fn_Pre_Query (p_Source,
               p_Source_Operation,
               p_Function_Id,
               p_Action_Code,
               p_function_Id  ,
               ...
               p_Err_Code  ,
               p_Err_Params ) THEN
               Dbg('Failed in stpks_stdklei1_Custom.Fn_Pre_Query..');
               RETURN FALSE;
            END IF;
         END IF;
         IF NOT stpks_stdklei1_Main.Fn_Skip_Sys THEN
         ...
         IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
            IF NOT stpks_stdklei1_Custom.Fn_Post_Query (p_Source,
               ...
               p_Err_Code  ,
               p_Err_Params ) THEN
               Dbg('Failed in stpks_stdklei1_Custom.Fn_Post_Query..');
               RETURN FALSE;
            END IF;
         END IF;
      END IF;
   ...
   BEGIN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Pre_Default_And_Validate (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdklei1_Custom.Fn_Pre_Default_And_Validate..');
            RETURN FALSE;
         END IF;
      END IF;
      IF NOT stpks_stdklei1_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Post_Default_And_Validate (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdklei1_Custom.Fn_Post_Default_And_Validate..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Pre_Upload_Db (p_Source,
            p_Source_operation,
            p_Function_id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdklei1_Custom.Fn_Pre_Upload_Db..');
            RETURN FALSE;
         END IF;
      END IF;
      IF NOT stpks_stdklei1_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdklei1_Custom.Fn_Post_Upload_Db (p_Source,
            p_Source_operation,
            p_Function_id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdklei1_Custom.Fn_Post_Upload_Db..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdklei1_Main.Fn_Upload_Db ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Summary_Rec     STTM_KLEI%ROWTYPE;
   ...
   BEGIN
      ...
      IF  p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
         ...
         IF g_Key_Id IS NOT NULL THEN
            l_Summary_Rec := p_stdklei1.v_sttm_klei;
            IF l_Summary_Rec_Found THEN
               ...
               p_Record_Master.CHAR_FLD_1 := l_Summary_Rec.DESCRIPTION1;
               p_Record_Master.CHAR_FLD_2 := l_Summary_Rec.GROUP_CODE;
               p_Record_Master.CHAR_FLD_3 := l_Summary_Rec.EXPOSURE_CATEGORY;
   ...
   RETURN BOOLEAN IS
      ...
      l_wrk_stdklei1      stpks_stdklei1_Main.Ty_stdklei1;
      l_Skip_custom      BOOLEAN := FALSE;
      ...
      IF  p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen,Cspks_Req_Global.p_Auth,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete) THEN
         ...
         IF l_Key_Id IS NOT NULL THEN
            IF p_Action_Code IN( Cspks_Req_Global.p_auth,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete) THEN
               IF p_stdklei1.v_sttm_klei.Mod_no IS NOT NULL THEN
                  l_Mod_No           := p_stdklei1.v_sttm_klei.Mod_No;
               ELSE
                  l_Mod_No           := p_Wrk_stdklei1.v_sttm_klei.Mod_No;
               END IF;
            ELSE
               l_mod_no           := p_wrk_stdklei1.v_sttm_klei.mod_no;
            END IF;
              l_Auth_Stat := NVL(p_Wrk_stdklei1.v_sttm_klei.Auth_Stat,'U') ;
            ...
            IF Cspks_Req_Utils.Fn_Field_Log_Reqd(p_Function_Id,p_Action_Code) THEN
               ...
               IF p_Prev_stdklei1.v_sttm_klei.group_code IS NOT NULL THEN
               ...
               IF l_Prev_Found   THEN
                  l_Dtl_key := '~STTM_KLEI~'||p_Prev_stdklei1.v_sttm_klei.group_code||'~';
               ELSIF l_Wrk_Found   THEN
                  l_Dtl_key := '~STTM_KLEI~'||p_Wrk_stdklei1.v_sttm_klei.group_code||'~';
               END IF;
               IF l_Wrk_Found  OR l_Prev_Found THEN
                  ...
                  ELSIF (NOT l_wrk_Found)  AND l_Prev_Found THEN
                     l_Rec_Action := 'D';
                  END IF;
                  Pr_Log_Change('DESCRIPTION1',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.description1,p_Wrk_stdklei1.v_sttm_klei.description1);
Pr_Log_Change('EXPOSURE_CATEGORY',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.exposure_category,p_Wrk_stdklei1.v_sttm_klei.exposure_category);
Pr_Log_Change('GROUP_CODE',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.group_code,p_Wrk_stdklei1.v_sttm_klei.group_code);
Pr_Log_Change('GROUP_STATUS',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.group_status,p_Wrk_stdklei1.v_sttm_klei.group_status);
Pr_Log_Change('GROUP_TYPE',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.group_type,p_Wrk_stdklei1.v_sttm_klei.group_type);
Pr_Log_Change('SINCE',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.since,p_Wrk_stdklei1.v_sttm_klei.since);
Pr_Log_Change('MAKER_ID',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.maker_id,p_Wrk_stdklei1.v_sttm_klei.maker_id);
Pr_Log_Change('MAKER_DT_STAMP',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.maker_dt_stamp,p_Wrk_stdklei1.v_sttm_klei.maker_dt_stamp);
Pr_Log_Change('CHECKER_ID',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.checker_id,p_Wrk_stdklei1.v_sttm_klei.checker_id);
Pr_Log_Change('CHECKER_DT_STAMP',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.checker_dt_stamp,p_Wrk_stdklei1.v_sttm_klei.checker_dt_stamp);
Pr_Log_Change('MOD_NO',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.mod_no,p_Wrk_stdklei1.v_sttm_klei.mod_no);
Pr_Log_Change('RECORD_STAT',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.record_stat,p_Wrk_stdklei1.v_sttm_klei.record_stat);
Pr_Log_Change('AUTH_STAT',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.auth_stat,p_Wrk_stdklei1.v_sttm_klei.auth_stat);
Pr_Log_Change('ONCE_AUTH',l_Rec_Action,p_Prev_stdklei1.v_sttm_klei.once_auth,p_Wrk_stdklei1.v_sttm_klei.once_auth);
            ...
            IF NOT stpks_stdklei1_Main.Fn_Skip_custom  THEN
               IF NOT stpks_stdklei1_Custom.Fn_Post_Upload_Db (p_Source,
                  ...
                  p_Err_Code,
                  p_Err_Params) THEN
                  Dbg('Failed in stpks_stdklei1_Custom.Fn_Post_Upload_Db After Logging');
                  RETURN FALSE;
               END IF;
            END IF;
            g_Skip_custom:= l_Skip_custom;
   ...
   RETURN BOOLEAN IS
      ...
      l_stdklei1     stpks_stdklei1_Main.Ty_stdklei1;
   ...
   BEGIN
      ...
      IF NOT  Fn_Get_Key_Information(p_Source,
         ...
         RAISE e_Failure_Exception;
      END IF;
      p_Addl_Info := l_stdklei1.Addl_Info;
   ...
   BEGIN
      ...
      p_Node_Data(l_Cntr).Node_Name := 'BLK_KLEI';
      p_Node_Data(l_Cntr).Xsd_Node := 'Klei';
      p_Node_Data(l_Cntr).Node_Parent := '';
      p_Node_Data(l_Cntr).Node_Relation_Type := '1';
      p_Node_Data(l_Cntr).Query_Node := '0';
      p_Node_Data(l_Cntr).Node_Fields := 'DESCRIPTION1~EXPOSURE_CATEGORY~GROUP_CODE~GROUP_STATUS~GROUP_TYPE~SINCE~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH~';
      p_Node_Data(l_Cntr).Node_Tags := 'DESCRIPTION1~EXPOSURE_CATEGORY~GROUP_CODE~GROUP_STATUS~GROUP_TYPE~SINCE~MAKER~MAKERSTAMP~CHECKER~CHECKERSTAMP~MODNO~TXNSTAT~AUTHSTAT~ONCEAUTH~';
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others Of stpks_stdklei1_Main.Fn_Get_Node_Data..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Wrk_stdklei1    stpks_stdklei1_Main.Ty_stdklei1;
      l_Prev_stdklei1    stpks_stdklei1_Main.Ty_stdklei1;
      l_Dmy_stdklei1    stpks_stdklei1_Main.Ty_stdklei1;
   ...
   BEGIN
      ...
      SAVEPOINT Sp_Int_Main_Stdklei1;
      p_Status := 'S';
      g_Tanking_Status := l_Tanking_Status;
      g_stdklei1 := p_stdklei1;
      l_Wrk_stdklei1 := p_stdklei1;
      ...
      IF NOT  Fn_Get_Key_Information(p_Source,
         ...
         RAISE e_Failure_Exception;
      END IF;
      l_Sent_Mod_No := p_stdklei1.v_sttm_klei.Mod_No;
      ...
      ELSE
         ...
         IF l_Resultant_Error_Type <> 'E' THEN
            ...
            IF  l_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
               l_Prev_Auth_Stat := NVL(l_Prev_stdklei1.v_sttm_klei.Auth_Stat,'A') ;
               --Get Upload Status
      ...
      IF l_Action_Code = Cspks_Req_Global.p_Delete AND p_Source = 'FLEXCUBE'  THEN
         l_Wrk_stdklei1 := l_Dmy_stdklei1;
      END IF;
      p_stdklei1 := l_wrk_stdklei1;
      Dbg('Errors     :'||p_Err_Code);
      Dbg('Parameters :'||p_Err_Params);
   ...
   EXCEPTION
      WHEN E_Failure_Exception THEN
         ...
         ROLLBACK TO Sp_Int_Main_Stdklei1;
         p_Status        := 'F';
         l_Post_Upl_Stat := 'F';
         Cspks_Req_Utils.Pr_Get_Final_Err_Code(p_Function_Id,l_Action_Code,l_Post_Upl_Stat,p_Err_Code,p_Err_Params);
         Pr_Log_Error(p_Source,p_Err_Code,p_Err_Params);
