CREATE OR REPLACE PACKAGE  stpks_stdklei1_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdklei1_main.spc
  **
...
TYPE ty_stdklei1 IS RECORD (
     v_sttm_klei     sttm_klei%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdklei1_main FOR stpks_stdklei1_main
/